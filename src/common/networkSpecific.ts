...
const wethMarketProxyAddress = new Map<string, Address>()
    ...
    .set(SupportedChain.ARBITRUM, Address.fromString("0x6f7D514bbD4aFf3BcD1140B7344b32f063dEe486")) 
    .set(SupportedChain.OPTIMISM, Address.fromString("0xE36A30D249f7761327fd973001A32010b521b6Fd"))
    .set(SupportedChain.SCROLL, ZERO_ADDRESS) // None exists
    .set(SupportedChain.SEPOLIA, Address.fromString("0x2943ac1216979aD8dB76D9147F64E61adc126e96"))
    .set(SupportedChain.BASE_SEPOLIA, Address.fromString("0x61490650AbaA31393464C3f34E8B29cd1C44118E"))
    .set("fallback", ZERO_ADDRESS);
